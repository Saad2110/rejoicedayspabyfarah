            ...
            <table id="pwgc-email-gift-card-table-table">
                ...
                <tr>
                    <td id="pwgc-email-gift-card-redeem-cell">
                        <?php
                            if ( !empty( $item_data->expiration_date ) && 'no' === get_option( 'pwgc_no_expiration_date', 'no' ) ) {
                                ?>
                                <div id="pwgc-email-expiration-date-section" class="pwgc-email-section pwgc-expiration-date-element">

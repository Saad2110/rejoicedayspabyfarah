        ...
        <div class="pwgc-setup-section">
            <div class="pwgc-setup-header">
                <?php
                    ...
                    printf( __( 'Create a "%s" product to start selling Gift Cards.', 'pw-woocommerce-gift-cards' ), PWGC_PRODUCT_TYPE_NAME );
                ?>
            </div>
            <?php
        ...
        <div class="pwgc-setup-section">
            ...
            <?php
                if ( empty( $balance_page ) ) {
                    ...
                    ?>
                    <p><?php
                        // translators: %s is a link to the shortcode manual on wordpress.com
                        printf( __( 'Create a page with the %s', 'pw-woocommerce-gift-cards' ), '<a href="https://support.wordpress.com/shortcodes/" target="_blank">shortcode</a>' );
                    ?> <span class="pwgc-shortcode">[<?php echo PWGC_BALANCE_SHORTCODE; ?>]</span></p>

        ...
        foreach ( $order->getItems() as $item ) {
            ...
            foreach ( $sub_items as $sub_item ) {
                ...
                if ( $sub_item->getCA()->getLastStatus() !== 'waitlisted' ) {
                    ...
                    $start_date = $sub_item->getAppointment()->getStartDate();
                    $this->cart_info[] = array(
                        'appointment_price' => $price,
                        'appointment_start' => $start_date ? $this->applyItemTz( $start_date, $sub_item ) : null,
                        'appointment_end' => $start_date ? $this->applyItemTz( $sub_item->getAppointment()->getEndDate(), $sub_item ) : null,
                        ...
                        'staff_email' => $sub_item->getStaff()->getEmail(),
                        'extras' => $extras,
